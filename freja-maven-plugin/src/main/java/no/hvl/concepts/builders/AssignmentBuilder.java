...
public class AssignmentBuilder {
    ...
    private List<CompilationUnit> modifyJavaFiles(TargetProject targetProject){
        ...
        removeFrejaInformation(files, targetProject);
        for(Task task : tasks){
    ...
    private void removeFrejaInformation(List<CompilationUnit> files, TargetProject targetProject){
    ...
    private void removeFrejaImports(List<CompilationUnit> files) {
